    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col p-1 w-[280px]'>
            ...
            {search === 'Pesquisar Doador' && <div className='flex flex-col'>
                <input type='search' placeholder='Nome/Telefone/Código' className={errors.codnametel ? 'rounded py-0.5 border-red-600 placeholder-red-600' : 'rounded py-0.5'} {...register('codnametel', { required: true })} />
                <div className='flex'>
            ...
            {search === 'Código da Doação' && <div className='flex flex-col'>
                <input type='search' placeholder='Código da Doação' className={errors.coddonation ? 'rounded py-0.5 border-red-600 placeholder-red-600' : 'rounded py-0.5'} {...register('coddonation', { required: true })} />
