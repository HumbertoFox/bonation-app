        ...
        <form className='p-1 w-[280px]' onSubmit={handleSubmit(onSubmit)}>
            {title === 'Cadastrar Veículo' && (
                <div className='flex flex-col gap-[5px]'>
                    ...
                    <input
                        type='text'
                        placeholder={errors.plate ? 'Campo Obrigatório' : 'Placa'}
                        className={errors.plate ? 'rounded py-0.5 border-red-600 placeholder-red-600' : 'rounded py-0.5'}
                        {...register('plate', { required: true })}
                    />
                    <input
                        type='number'
                        placeholder={errors.km ? 'Campo Obrigatório' : 'Km'}
                        className={errors.km ? 'rounded py-0.5 border-red-600 placeholder-red-600' : 'rounded py-0.5'}
            ...
            {title !== 'Cadastrar Veículo' && (
                <fieldset className='flex flex-col gap-[5px]' disabled={value === 'Donation' ? true : false}>
                    ...
                    {title === 'Editar Doador' && (
                        <input type='text'
                            disabled placeholder='Código do Doador'
                    ...
                    {title !== 'Entrar' && (
                        <input
                            type='text'
                            placeholder={errors.name ? 'Campo Obrigatório' : 'Nome'}
                            className={errors.name ? 'rounded py-0.5 border-red-600 placeholder-red-600' : 'rounded py-0.5'}
                    ...
                    {page === 'Menu' && (
                        <div className='flex gap-1'>
                            <label htmlFor='dateofbirth'>Data de Nascimento
                                <input
                                    type='date'
                                    className={errors.dateofbirth ? 'w-full rounded py-0.5 border-red-600 placeholder-red-600' : 'w-full rounded py-0.5'}
                    ...
                    {page !== 'Login' && (
                        <input
                            type='tel'
                            placeholder={errors.telephone ? 'Campo Obrigatório' : page !== 'Menu' ? 'Contato do Responsável' : 'Telefone'}
                            className={errors.telephone ? 'rounded py-0.5 border-red-600 placeholder-red-600' : 'rounded py-0.5'}
                    ...
                    {(page === 'Dashboard') && (
                        <div className='flex flex-col gap-[5px]'>
                            <input
                                type='tel'
                                placeholder={errors.contact1 ? 'Campo Obrigatório' : 'Contato do Responsável/Opcional'}
                                className={errors.contact1 ? 'rounded py-0.5 border-red-600 placeholder-red-600' : 'rounded py-0.5'}
                    ...
                    {title !== 'Entrar' && (
                        <div className='flex flex-col gap-[5px]'>
                            <input
                                type='number'
                                placeholder={errors.zipcode ? 'Campo Obrigatório' : 'CEP'}
                                className={errors.zipcode ? 'rounded py-0.5 border-red-600 placeholder-red-600' : 'rounded py-0.5'}
                                {...register('zipcode', { required: true, onBlur: checkedZipCode })}
                            />
                            <input
                                type='text'
                                placeholder={errors.street ? 'Campo Obrigatório' : 'Logradouro: Av/Rua/Trav'}
                                className={errors.street ? 'rounded py-0.5 border-red-600 placeholder-red-600' : 'rounded py-0.5'}
                                {...register('street', { required: true })}
                            />
                            <input
                                type='text'
                                placeholder={errors.district ? 'Campo Obrigatório' : 'Bairro/Distrito'}
                                className={errors.district ? 'rounded py-0.5 border-red-600 placeholder-red-600' : 'rounded py-0.5'}
                                {...register('district', { required: true })}
                            />
                            <input
                                type='text'
                                placeholder={errors.city ? 'Campo Obrigatório' : 'Cidade'}
                                className={errors.city ? 'rounded py-0.5 border-red-600 placeholder-red-600' : 'rounded py-0.5'}
                                {...register('city', { required: true })}
                            />
                            <input
                                type='text'
                                placeholder={errors.numresidence ? 'Campo Obrigatório' : 'Nº Casa/Edifício'}
                                className={errors.numresidence ? 'rounded py-0.5 border-red-600 placeholder-red-600' : 'rounded py-0.5'}
                            ...
                            <div className='flex gap-5 justify-center p-1'>
                                <label htmlFor='house' className='flex items-center cursor-pointer'>
                                    <input
                                        ...
                                        className='mr-1.5'
                                        defaultChecked
                                        {...register('typeresidence', { onChange: swapRadioSelectHbe })}
                                    />
                                    Casa
                                </label>
                            ...
                            {radioSelectHbe === 'enterprise' && (
                                <input
                                    type='text'
                                    placeholder={errors.cnpj ? 'Campo Obrigatório' : 'CNPJ'}
                                    className={errors.cnpj ? 'rounded py-0.5 border-red-600 placeholder-red-600' : 'rounded py-0.5'}
                            ...
                            {radioSelectHbe !== 'house' && (
                                <div className='flex flex-col gap-[5px]'>
                                    {radioSelectHbe === 'enterprise' && (
                                        <input
                                            type='text'
                                            placeholder={errors.corporatename ? 'Campo Obrigatório' : 'Razão Social'}
                                            className={errors.corporatename ? 'rounded py-0.5 border-red-600 placeholder-red-600' : 'rounded py-0.5'}
                                            {...register('corporatename', { required: true })}
                                        />
                                    )}
                                    <input
                                        type='text'
                                        placeholder={errors.building ? 'Campo Obrigatório' : 'Nome do Edifício'}
                                        className={errors.building ? 'rounded py-0.5 border-red-600 placeholder-red-600' : 'rounded py-0.5'}
                                        {...register('building', { required: true })}
                                    />
                                    <input
                                        type='text'
                                        placeholder={errors.block ? 'Campo Obrigatório' : 'Bloco'}
                                        className={errors.block ? 'rounded py-0.5 border-red-600 placeholder-red-600' : 'rounded py-0.5'}
                                        {...register('block', { required: true })}
                                    />
                                    <input
                                        type='text'
                                        placeholder={errors.livingapartmentroom ? 'Campo Obrigatório' : 'Apartamento/Sala'}
                                        className={errors.livingapartmentroom ? 'rounded py-0.5 border-red-600 placeholder-red-600' : 'rounded py-0.5'}
                                        {...register('livingapartmentroom', { required: true })}
                                    />
                                </div>
                            )}
                            {(value === 'Cadastrar' || value === 'Donation' || value === 'Editar') && (
                                <textarea
                                    placeholder={errors.referencepoint ? 'Campo Obrigatório' : 'Ponto de Referência'}
                                    className={errors.referencepoint ? 'rounded py-0.5 h-20 border-red-600 placeholder-red-600' : 'rounded py-0.5 h-20'}
                                    {...register('referencepoint', { required: true })}
                                />
                            )}
                        </div>
                    )}
                    {(title === 'Entrar' || title === 'Cadastrar Usuário') && (
                        <div>
                            <input
                                ...
                                placeholder={errors.password ? 'Campo Obrigatório' : 'Senha'}
                                className={errors.password ? 'w-full rounded py-0.5 border-red-600 placeholder-red-600' : 'w-full rounded py-0.5'}
                                autoComplete='off'
                                {...register('password', { required: true })}
                            />
                            <button type='button' className='relative' onClick={handlePassword} >
                                {!ispassword && (
                                    <FontAwesomeIcon icon={faEye} className='absolute bottom-[-1px] left-0.5 text-[grey]' />
                                )}
                                {ispassword && (
                                    <FontAwesomeIcon icon={faEyeSlash} className='absolute bottom-[-1px] left-0.5 text-[grey]' />
                                )}
                            </button>
                        </div>
                    )}
                    {title === 'Cadastrar Usuário' && (
                        <div>
                            <input
                                ...
                                placeholder={errors.passwordcheck ? 'Campo Obrigatório' : 'Confirmar Senha'}
                                className={errors.passwordcheck ? 'w-full rounded py-0.5 border-red-600 placeholder-red-600' : 'w-full rounded py-0.5'}
                                autoComplete='off'
                                {...register('passwordcheck', { required: true, validate: (value) => value === password })}
                            />
            ...
            {value !== 'Donation' && (
                <div className='flex'>
                    {title === 'isblocked' && (
                        <input
                            title={radioSelectIsBloking === 'false' ? 'Desbloquear Usuário' : 'Bloquear Usuário'}
                            type='submit' value={radioSelectIsBloking === 'false' ? 'Desbloquear' : 'Bloquear'}
                    ...
                    {title === 'Cadastrar Doador' && (
                        <input
                            type='submit'
                            title='Cadastrar e ir para Cadastrar Doação'
                            value='Doação'
                            className='bg-blue-600 text-white font-bold py-1 px-2 duration-[400ms] cursor-pointer mx-auto rounded drop-shadow-[1px_1px_0.5px_#AAF998] hover:bg-green-600 hover:drop-shadow-[1px_1px_0.5px_#79D1FF] active:bg-blue-600 active:text-black mt-3'
                            onClick={() => setGoToDonation(true)}
                        />
                    )}
                    {page === 'Menu' && (
                        <button
